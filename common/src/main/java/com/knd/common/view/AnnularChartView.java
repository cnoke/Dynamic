...
//    private static final int[] DEFAULT_COLOR = new int[]{0xff82B8FF, 0xffFF7F78, 0xffFFAE72, 0xff74D1B1, 0xffC38AFC};
    public static final int[] DEFAULT_COLOR = new int[]{0xffB15592, 0xffFCB42D, 0xff37C7A7, 0xff555F9A, 0xffC38AFC};
    /**
     * 圆环半径，以内环算
     */
    ...
    private void initRectF(int w, int h) {
        ...
        ringWidth = (int) ((float) w / 2 / 100 * 30);
        innerRadius = centerX - ringWidth / 2;
