...
public abstract class BasePagingModel<T> extends SuperBaseModel<T> {
     ...
     */
    protected void loadSuccess(final T data, final boolean isEmpty, final boolean isFirstPage,
        ...
        synchronized (this) {
            mUiHandler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    if (BasePagingModel.this.getCachedPreferenceKey() != null && isFirstPage) {
//                        BasePagingModel.this.saveDataToPreference(data);
                    }
                }
            }, 0);
        }
