...
public class Hon2Line3ContentAdapter extends BaseQuickAdapter<ElementBean, Hon2Line3ContentAdapter.MyViewHolder> {

    public Hon2Line3ContentAdapter(@Nullable List<ElementBean> data) {
        super(R.layout.dynamic_item_series_course, data);
    }
